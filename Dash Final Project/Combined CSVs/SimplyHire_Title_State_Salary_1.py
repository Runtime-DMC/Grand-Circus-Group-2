...
# Load data
df = pd.read_csv("C:/Users/battl/Documents/Dash Final Project/Combined CSVs/SimplyHired_Title_Salary_State.csv")
...
# Define layout
app.layout = html.Div([
    html.H1("Simply Hired Job Title by State and Salary"),
    dcc.Dropdown(
...
def update_figure(selected_job_title):
    ...
    fig.update_traces(mode='markers', marker=dict(color=['red' if t == 'Yearly' else 'blue' for t in filtered_df['Salary Type']]))
