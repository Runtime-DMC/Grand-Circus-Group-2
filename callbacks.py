...
from data_visualization import create_salary_box_plot, get_valid_options
from data_visualization import indeed_pie_chart, simply_hired_pie_chart, dice_pie_chart, generate_stacked_bar_chart


def get_callbacks(app):
    # This callback updates the 'job-listings-container' based on the selected value from the 'job-source' radio buttons.
    @app.callback(
