...
url = 'https://www.dice.com/jobs?q=data%20scientist&countryCode=US&radius=30&radiusUnit=mi&pageSize=100&language=en&page='
...
print(df.head(10))
df.to_csv('dice_DataScientist_2023.csv')
#driver.close()
